...
|   |    |
|-------|-----|
| ![](./images/00_continue.png)  | Чтобы сохранить внесенные изменения нужно нажать кнопку **Продолжить** |
| ![](./images/00_break.png) | Чтобы выйти из режима редактирования без сохранения изменений необходимо нажать кнопку **Отменить** |
