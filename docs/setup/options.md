...
|:--|:--|:--|
| **-c** |	Запрашивать подтверждение, даже если не обнаружено ошибок |	Если в параметрах запуска утилиты задать ключ **-c**, то после выполнения распознавания документа раздел с распознанными данными будет всегда открываться в режиме редактирования <a href="../use.md/#рис.6">рис.6</a>, даже если не возникло ошибок распознавания. Данный ключ не имеет дополнительных параметров. |
...
|:--:| 
| *Рисунок 8. ППараметры импорта данных* |
